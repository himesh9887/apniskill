...
export default function Home() {
  ...
  return (
    <div className="space-y-24 pb-16">
      <section className="relative overflow-hidden rounded-[36px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.16),transparent_35%),radial-gradient(circle_at_bottom_right,rgba(251,191,36,0.16),transparent_38%),linear-gradient(145deg,rgba(15,23,42,0.98),rgba(2,6,23,0.9))] px-6 py-16 md:px-10 lg:px-16 lg:py-24">
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.2fr_0.8fr]">
          <MotionDiv initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
            <div className="inline-flex items-center gap-2 rounded-full border border-sky-300/20 bg-sky-300/10 px-4 py-2 text-sm text-sky-200">
              ...
              <span>Skill-sharing that actually feels usable</span>
            </div>
          ...
          >
            ...
            <div className="space-y-5">
              <div className="flex items-center justify-between">
                <p className="text-sm uppercase tracking-[0.24em] text-slate-400">Featured match</p>
